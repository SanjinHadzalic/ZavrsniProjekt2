...
INSERT INTO accuracy_of_coordinates (code, language, description)
VALUES ('A', 'en', 'Somewhere in a circle with radius 1 m'),
...
INSERT INTO accuracy_of_date (code, language, description)
VALUES ('A', 'en', 'Exact date'),
...
INSERT INTO accuracy_of_pullus_age (code, language, description)
VALUES ('P1', 'en', 'Age within 1 day'),
...
INSERT INTO age (code, language, description)
VALUES ('J', 'en', 'Juvenile'),
       ('A', 'en', 'Adult'),
       ('I', 'en', 'Immature'),
       ('N', 'en', 'Nestling'),
       ('F', 'en', 'Fledgling'),
...
INSERT INTO alula (code, language, description)
VALUES ('A1', 'en', 'First primary feather'),
...
VALUES -- ROLE_ gets concatenated
       ('USER'),
       ('ADMIN'),
       ('MODERATOR');

INSERT INTO users (firstname, lastname, email, username, password)
VALUES ('John', 'Doe', 'jdoe13@gmail.com', 'admin',
        '$2a$12$RbH0HjMtuaOSK./5Jf7uQ.yG/rUCvTlE7xAJOuzwaUQTteN94oJ.a'), --password
       ('Jane', 'Smith', 'janedoe12@hotmail.com', 'user',
        '$2a$12$RbH0HjMtuaOSK./5Jf7uQ.yG/rUCvTlE7xAJOuzwaUQTteN94oJ.a'); --password
...
INSERT INTO bill_method (code, language, description)
VALUES ('BM001', 'en', 'Standard Billing Method'),
...
INSERT INTO brood_patch (score, language, description)
VALUES ('BP001', 'en', 'Fully developed brood patch'),
...
INSERT INTO brood_size (code, language, description)
VALUES ('BS001', 'en', 'One young alive'),
...
INSERT INTO carpal_covert (code, language, description)
VALUES ('CC001', 'en', 'Full carpal covert'),
...
INSERT INTO catching_lures (code, language, description)
VALUES ('CL001', 'en', 'Lure type A'),
...
INSERT INTO catching_methods (code, language, description)
VALUES ('CM001', 'en', 'Method A'),
       ('CM002', 'en', 'Method B'),
       ('CM003', 'en', 'Method C'),
       ('CM004', 'en', 'Method D'),
       ('CM005', 'en', 'Method E'),
...
INSERT INTO circumstances_presumed (code, language, description)
VALUES ('CP001', 'en', 'Presumed circumstances A'),
...
INSERT INTO condition (code, language, description)
VALUES ('C001', 'en', 'Healthy condition'),
...
VALUES ('E001', 'en', 'European ring code'),
       ('E002', 'en', 'Non-European ring code'),
       ('E003', 'en', 'Standard ring code'),
       ('E004', 'en', 'Special ring code'),
       ('E005', 'en', 'Experimental ring code');

INSERT INTO fat_score (score, language, description)
VALUES ('FS01', 'en', 'Low fat score according to BTO standards'),
...
INSERT INTO manipulated (code, language, description)
VALUES ('R', 'en', 'Ringing has caused injury to the bird'),
...
INSERT INTO metal_ring_information (code, language, description)
VALUES ('R', 'en', 'Metal ring is present, no additional ring should be added'),
...
INSERT INTO moult (code, language, description)
VALUES ('P', 'en', 'Primary moult'),
       ('S', 'en', 'Secondary moult'),
       ('F', 'en', 'Facial moult'),
       ('C', 'en', 'Complete moult'),
       ('N', 'en', 'No moult observed');

INSERT INTO moved_before_the_encounter (code, language, description)
VALUES ('M1', 'en', 'Moved to another location before capture'),
...
INSERT INTO other_marks_information (code, language, description)
VALUES ('ZZ', 'en', 'No marks other than metal ring'),
...
insert into pullus_age(code, language, description)
values ('--', 'en', 'Bird is not a pullus'),
       ('99', 'en', 'Pullus age not recorded'),
       ('00', 'en', 'Pullus age 0 days.'),
       ('01', 'en', 'pullus age 1 day'),
       ('13', 'en', 'Pullus age 13 days'),
       ('44', 'en', 'Pullus age 44 days');

INSERT INTO pectoral_muslce_score (code, language, description)
VALUES ('A', 'en', 'Excellent pectoral muscle condition'),
...
INSERT INTO primary_identification_method (code, language, description)
VALUES ('M', 'en', 'Metal ring'),
       ('T', 'en', 'Transponder'),
       ('B', 'en', 'Biometric'),
       ('L', 'en', 'Leg band'),
       ('C', 'en', 'Color band'),
...
INSERT INTO sex (code, language, description)
VALUES ('M', 'en', 'Male'),
       ('F', 'en', 'Female'),
       ('U', 'en', 'Unknown');

INSERT INTO sexing_method (code, language, description)
VALUES ('M', 'en', 'Method for identifying male birds'),
...
INSERT INTO state_of_wing_point (code, language, description)
VALUES ('1', 'en', 'Normal wing point condition'),
...
INSERT INTO status (code, language, description)
VALUES ('R', 'en', 'Roosting'),
       ('W', 'en', 'Wintering'),
       ('N', 'en', 'Nesting'),
       ('M', 'en', 'Moulting'),
...
INSERT INTO tarsus_method (code, language, description)
VALUES ('M1', 'en', 'Method 1: Standard Tarsus Measurement'),
       ('M2', 'en', 'Method 2: Alternative Tarsus Measurement'),
       ('M3', 'en', 'Method 3: Tarsus Measurement with Special Tools');

INSERT INTO verification_of_the_metal_ring (code, language, description)
VALUES ('0', 'en', 'Ring not verified by the scheme'),
...
INSERT INTO ringed_bird (ringing_scheme_id, primary_identification_method_id, ring_code_id, species_id, place_code_id, date, time,
                         remarks, reference)
VALUES (1, 1, 1, 1, 1, '2023-01-01', '11:00', 'Initial ringed bird record', null),
       (1, 1, 2, 2, 1, '2024-01-01', '12:00', 'Initial ringed bird record', null),
       (1, 1, 3, 3, 2, '2024-01-01', '12:00', 'Initial ringed bird record', null),
       (1, 1, 1, 1, 2, '2024-05-05', '15:00', 'Initial ringed bird record', 'BJ001');
